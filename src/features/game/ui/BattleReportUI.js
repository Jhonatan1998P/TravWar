...
const ICONS = {
    ...
    stone: `<img src="/icons/clay.webp" alt="Barro" class="h-[25px] w-[25px]">`,
    iron: `<img src="/icons/iron.webp" alt="Hierro" class="h-[25px] w-[25px]">`,
    food: `<img src="/icons/wheat.webp" alt="Cereal" class="h-[25px] w-[25px]">`,
...
class BattleReportUI {
    ...
    _initializeEventListeners() {
        ...
        }, [selectBattleReportPanelSignature]);
    }
