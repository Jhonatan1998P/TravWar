...
const ICONS = {
    ...
    sword: `<img src="assets/icons/sword.png" alt="Ataque" class="h-5 w-5">`,
    shield: `<img src="assets/icons/shield.png" alt="Defensa" class="h-5 w-5">`,
    wood: `<img src="assets/icons/wood.png" alt="Madera" class="h-5 w-5">`,
    stone: `<img src="assets/icons/clay.png" alt="Barro" class="h-5 w-5">`,
    iron: `<img src="assets/icons/iron.png" alt="Hierro" class="h-5 w-5">`,
    food: `<img src="assets/icons/wheat.png" alt="Cereal" class="h-5 w-5">`,
    bounty: `<img src="assets/icons/bolsa.png" alt="Recompensa" class="h-5 w-5">`,
    capacity: `<img src="assets/icons/bolsa.png" alt="Capacidad" class="h-5 w-5">`,
