...
const ASSET_PATHS = {
    ...
    wasteland: 'assets/icons/baldio.png',
    compass: 'assets/icons/compass.png'
};
    ...
    get html() {
        return `
            ...
            <div id="map-controls-cluster" class="absolute bottom-5 left-1/2 -translate-x-1/2 flex items-center justify-center gap-4 z-30">
                ...
                <img id="center-map-btn" src="assets/icons/compass.png" alt="Centrar Mapa" class="h-8 w-8 cursor-pointer hover:opacity-80 transition-opacity">
