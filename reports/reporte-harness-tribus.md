...
| Escenario | Tribu | Fase final | Transiciones | Aldeas | Comandos | Expansiones |
|---|---|---|---:|---:|---:|---:|
| seed_x1@1x | Egipcios | F6 hardening | 2 | 3 | 1 | 1 |
| seed_x1@1x | Germanos | F4 presion y tecnologia | 3 | 3 | 4 | 1 |
| seed_x100@100x | Egipcios | F6 hardening | 2 | 3 | 1 | 1 |
| seed_x100@100x | Germanos | F4 presion y tecnologia | 3 | 3 | 4 | 1 |
| seed_x1000@1000x | Egipcios | F6 hardening | 2 | 3 | 1 | 1 |
| seed_x1000@1000x | Germanos | F4 presion y tecnologia | 3 | 3 | 4 | 1 |

## 🚀 Escenario seed_x1@1x

| Tribu | Fase final | Transiciones | Comandos | Refuerzos | Raids | Ataques | Expansiones |
|---|---|---:|---:|---:|---:|---:|---:|
| Egipcios | F6 hardening | 2 | 1 | 0 | 1 | 0 | 1 |
| Germanos | F4 presion y tecnologia | 3 | 4 | 1 | 3 | 0 | 1 |

### 🧾 Egipcios (seed_x1@1x)

**Macro por ciclo (aldea principal)**
...
| Evento | Tipo | Amenaza/Respuesta | Estado final | Comandos | Contraataque diferido |
|---|---|---|---|---|---:|
| E1 | Espionaje de apertura | espionaje | partial_dodge (threat=low) | raid@egyptians_main | 0 |
| E2 | Raid ligero | light_raid/low → hold | hold (threat=low) | sin comandos | 0 |
| E3 | Ataque estandar debil | standard_attack/medium → hold | hold (threat=medium) | sin comandos | 0 |
| E4 | Ataque multi-ola | multi_wave_attack/high → hold | hold (threat=high) | sin comandos | 0 |
| E5 | Asedio de media intensidad | siege_attack/high → hold_with_reinforcements | hold_with_reinforcements (threat=high) | sin comandos | 0 |
| E6 | Ataque de conquista | conquest_attack/critical → hold_with_reinforcements | hold_with_reinforcements (threat=critical) | sin comandos | 0 |

**Expansión**

- ✅ EXP-1: `egyptians_main` funda `egyptians_main_exp_1` en `52|54`.

**KPI egipcios (hardening)**

| KPI | Valor |
|---|---:|
| threatInterruptedCycles | 4 |
| storagePressureCriticalSamples | 0 |
| expansionAttempts | 0 |
| expansionLaunches | 0 |
| expansionBlockedByThreat | 0 |
| emergencyRecruitmentCycles | 3 |

**Resumen final de tribu**

- 🧭 Fase final: **F6 hardening**
- 🔁 Transiciones: **2**
- 🏘️ Aldeas propias: **3**
- 📨 Comandos totales: **1**
- 🛡️ Refuerzos: **0** | 🏃 Raids: **1** | ⚔️ Ataques: **0**
- 🌱 Expansiones: **1**
...
| Ciclo | Fase | Aldeas | Acciones |
|---:|---|---:|---|
| 1 | F2 desbloqueo militar | 2 | investigacion:scout_german · campo:woodcutter -> nivel 5 |
| 2 | F2 desbloqueo militar | 2 | reclutamiento:clubswinger +4 · campo:woodcutter -> nivel 5 |
| 3 | F2 desbloqueo militar | 2 | reclutamiento:clubswinger +4 · campo:woodcutter -> nivel 5 |
| 4 | F3 produccion mixta | 2 | campo:woodcutter -> nivel 7 · campo:clayPit -> nivel 5 |
| 5 | F3 produccion mixta | 2 | campo:woodcutter -> nivel 7 · campo:clayPit -> nivel 5 |
| 6 | F3 produccion mixta | 2 | campo:woodcutter -> nivel 7 · campo:clayPit -> nivel 5 |
| 7 | F3 produccion mixta | 2 | campo:clayPit -> nivel 7 · campo:ironMine -> nivel 5 |
| 8 | F3 produccion mixta | 2 | campo:clayPit -> nivel 7 · campo:ironMine -> nivel 5 |
| 9 | F3 produccion mixta | 2 | campo:clayPit -> nivel 7 · campo:ironMine -> nivel 5 |
| 10 | F3 produccion mixta | 2 | campo:ironMine -> nivel 7 · campo:cropland -> nivel 5 |
| 11 | F3 produccion mixta | 2 | reclutamiento:spearman +1 · campo:cropland -> nivel 5 |
| 12 | F3 produccion mixta | 2 | reclutamiento:spearman +1 · campo:cropland -> nivel 5 |
| 13 | F3 produccion mixta | 2 | reclutamiento:spearman +2 · investigacion:scout_german |
| 14 | F3 produccion mixta | 2 | campo:ironMine -> nivel 7 · reclutamiento:clubswinger +4 |
| 15 | F3 produccion mixta | 2 | reclutamiento:spearman +2 · reclutamiento:clubswinger +4 |
| 16 | F3 produccion mixta | 2 | campo:ironMine -> nivel 7 · campo:woodcutter -> nivel 6 |
| 17 | F3 produccion mixta | 2 | reclutamiento:spearman +3 · campo:woodcutter -> nivel 6 |
| 18 | F3 produccion mixta | 2 | campo:cropland -> nivel 7 · campo:woodcutter -> nivel 6 |
| 19 | F3 produccion mixta | 2 | campo:cropland -> nivel 7 · campo:clayPit -> nivel 6 |
| 20 | F3 produccion mixta | 2 | campo:cropland -> nivel 7 · campo:clayPit -> nivel 6 |
| 21 | F4 presion y tecnologia | 2 | construccion:smithy -> nivel 7 · campo:clayPit -> nivel 6 |
| 22 | F4 presion y tecnologia | 2 | construccion:smithy -> nivel 8 · campo:ironMine -> nivel 6 |
| 23 | F4 presion y tecnologia | 2 | construccion:barracks -> nivel 9 · campo:ironMine -> nivel 6 |
| 24 | F4 presion y tecnologia | 2 | construccion:barracks -> nivel 10 · campo:ironMine -> nivel 6 |
| 25 | F4 presion y tecnologia | 2 | construccion:barracks -> nivel 11 · campo:cropland -> nivel 6 |
| 26 | F4 presion y tecnologia | 2 | construccion:barracks -> nivel 12 · campo:cropland -> nivel 6 |
| 27 | F4 presion y tecnologia + drill expansion | 3 | expansion:germans_main funda germans_main_exp_1 en 53/52 |
| 28 | F4 presion y tecnologia | 3 | campo:woodcutter -> nivel 8 · campo:cropland -> nivel 6 · campo:woodcutter -> nivel 2 |
| 29 | F4 presion y tecnologia | 3 | campo:woodcutter -> nivel 8 · campo:woodcutter -> nivel 7 · campo:woodcutter -> nivel 2 |
| 30 | F4 presion y tecnologia | 3 | campo:woodcutter -> nivel 8 · campo:woodcutter -> nivel 7 · campo:woodcutter -> nivel 2 |

**Eventos reactivos**

| Evento | Tipo | Amenaza/Respuesta | Estado final | Comandos | Contraataque diferido |
|---|---|---|---|---|---:|
| E1 | Espionaje de apertura | espionaje | partial_dodge (threat=low) | raid@germans_main | 0 |
| E2 | Raid ligero | light_raid/low → hold | hold (threat=low) | sin comandos | 0 |
| E3 | Ataque estandar debil | standard_attack/medium → counterattack | counterattack (threat=medium) | raid@germans_main | 1 |
| E4 | Ataque multi-ola | multi_wave_attack/high → hold | hold (threat=high) | sin comandos | 0 |
| E5 | Asedio de media intensidad | siege_attack/high → hold_with_reinforcements | hold_with_reinforcements (threat=high) | reinforcement@germans_support | 0 |
| E6 | Ataque de conquista | conquest_attack/critical → hold_with_reinforcements | partial_dodge (threat=critical) | raid@germans_main | 0 |

**Expansión**

- ✅ EXP-1: `germans_main` funda `germans_main_exp_1` en `53|52`.

**Resumen final de tribu**

- 🧭 Fase final: **F4 presion y tecnologia**
- 🔁 Transiciones: **3**
- 🏘️ Aldeas propias: **3**
- 📨 Comandos totales: **4**
- 🛡️ Refuerzos: **1** | 🏃 Raids: **3** | ⚔️ Ataques: **0**
- 🌱 Expansiones: **1**

## 🚀 Escenario seed_x100@100x

| Tribu | Fase final | Transiciones | Comandos | Refuerzos | Raids | Ataques | Expansiones |
|---|---|---:|---:|---:|---:|---:|---:|
| Egipcios | F6 hardening | 2 | 1 | 0 | 1 | 0 | 1 |
| Germanos | F4 presion y tecnologia | 3 | 4 | 0 | 4 | 0 | 1 |

### 🧾 Egipcios (seed_x100@100x)
...
- ✅ EXP-1: `egyptians_main` funda `egyptians_main_exp_1` en `54|54`.
...
|---:|---|---:|---|
| 1 | F2 desbloqueo militar | 2 | investigacion:scout_german · campo:woodcutter -> nivel 5 |
| 2 | F2 desbloqueo militar | 2 | reclutamiento:clubswinger +8 · campo:woodcutter -> nivel 5 |
| 3 | F3 produccion mixta | 2 | campo:woodcutter -> nivel 7 · campo:woodcutter -> nivel 5 |
| 4 | F3 produccion mixta | 2 | campo:woodcutter -> nivel 7 · campo:clayPit -> nivel 5 |
| 5 | F3 produccion mixta | 2 | campo:woodcutter -> nivel 7 · campo:clayPit -> nivel 5 |
| 6 | F3 produccion mixta | 2 | campo:clayPit -> nivel 7 · campo:clayPit -> nivel 5 |
| 7 | F3 produccion mixta | 2 | campo:clayPit -> nivel 7 · campo:ironMine -> nivel 5 |
| 8 | F3 produccion mixta | 2 | campo:clayPit -> nivel 7 · campo:ironMine -> nivel 5 |
| 9 | F3 produccion mixta | 2 | campo:ironMine -> nivel 7 · campo:ironMine -> nivel 5 |
| 10 | F3 produccion mixta | 2 | campo:ironMine -> nivel 7 · campo:cropland -> nivel 5 |
| 11 | F3 produccion mixta | 2 | reclutamiento:spearman +1 · campo:cropland -> nivel 5 |
| 12 | F3 produccion mixta | 2 | reclutamiento:spearman +1 · campo:cropland -> nivel 5 |
| 13 | F3 produccion mixta | 2 | reclutamiento:spearman +2 · investigacion:scout_german |
| 14 | F3 produccion mixta | 2 | campo:ironMine -> nivel 7 · reclutamiento:clubswinger +8 |
| 15 | F3 produccion mixta | 2 | reclutamiento:spearman +2 · campo:woodcutter -> nivel 6 |
| 16 | F3 produccion mixta | 2 | campo:cropland -> nivel 7 · campo:woodcutter -> nivel 6 |
| 17 | F3 produccion mixta | 2 | reclutamiento:spearman +3 · campo:woodcutter -> nivel 6 |
| 18 | F3 produccion mixta | 2 | campo:cropland -> nivel 7 · campo:clayPit -> nivel 6 |
| 19 | F3 produccion mixta | 2 | campo:cropland -> nivel 7 · campo:clayPit -> nivel 6 |
| 20 | F4 presion y tecnologia | 2 | construccion:smithy -> nivel 7 · campo:clayPit -> nivel 6 |
| 21 | F4 presion y tecnologia | 2 | construccion:smithy -> nivel 8 · campo:ironMine -> nivel 6 |
| 22 | F4 presion y tecnologia | 2 | construccion:barracks -> nivel 9 · campo:ironMine -> nivel 6 |
| 23 | F4 presion y tecnologia | 2 | construccion:barracks -> nivel 10 · campo:ironMine -> nivel 6 |
| 24 | F4 presion y tecnologia | 2 | construccion:barracks -> nivel 11 · campo:cropland -> nivel 6 |
| 25 | F4 presion y tecnologia | 2 | construccion:barracks -> nivel 12 · campo:cropland -> nivel 6 |
| 26 | F4 presion y tecnologia | 2 | campo:woodcutter -> nivel 8 · campo:cropland -> nivel 6 |
| 27 | F4 presion y tecnologia + drill expansion | 3 | expansion:germans_main funda germans_main_exp_1 en 52/52 |
| 28 | F4 presion y tecnologia | 3 | campo:woodcutter -> nivel 8 · campo:woodcutter -> nivel 7 · campo:woodcutter -> nivel 2 |
| 29 | F4 presion y tecnologia | 3 | campo:woodcutter -> nivel 8 · campo:woodcutter -> nivel 7 · campo:woodcutter -> nivel 2 |
| 30 | F4 presion y tecnologia | 3 | campo:clayPit -> nivel 8 · campo:woodcutter -> nivel 7 · campo:woodcutter -> nivel 2 |
...
| E3 | Ataque estandar debil | standard_attack/medium → counterattack | counterattack (threat=medium) | raid@germans_main | 1 |
| E4 | Ataque multi-ola | multi_wave_attack/high → hold | hold (threat=high) | sin comandos | 0 |
| E5 | Asedio de media intensidad | siege_attack/high → hold_with_reinforcements | partial_dodge (threat=high) | raid@germans_main | 0 |
| E6 | Ataque de conquista | conquest_attack/critical → full_dodge | partial_dodge (threat=critical) | raid@germans_main | 0 |

**Expansión**

- ✅ EXP-1: `germans_main` funda `germans_main_exp_1` en `52|52`.
...
- 🏘️ Aldeas propias: **3**
- 📨 Comandos totales: **4**
- 🛡️ Refuerzos: **0** | 🏃 Raids: **4** | ⚔️ Ataques: **0**
- 🌱 Expansiones: **1**

## 🚀 Escenario seed_x1000@1000x
...
- ✅ EXP-1: `egyptians_main` funda `egyptians_main_exp_1` en `52|52`.
...
|---:|---|---:|---|
| 1 | F2 desbloqueo militar | 2 | investigacion:scout_german · campo:woodcutter -> nivel 5 |
| 2 | F2 desbloqueo militar | 2 | reclutamiento:clubswinger +16 · campo:woodcutter -> nivel 5 |
| 3 | F3 produccion mixta | 2 | campo:woodcutter -> nivel 7 · campo:woodcutter -> nivel 5 |
| 4 | F3 produccion mixta | 2 | campo:woodcutter -> nivel 7 · campo:clayPit -> nivel 5 |
| 5 | F3 produccion mixta | 2 | campo:woodcutter -> nivel 7 · campo:clayPit -> nivel 5 |
| 6 | F3 produccion mixta | 2 | campo:clayPit -> nivel 7 · campo:clayPit -> nivel 5 |
...
| 12 | F3 produccion mixta | 2 | reclutamiento:spearman +1 · campo:cropland -> nivel 5 |
| 13 | F3 produccion mixta | 2 | reclutamiento:spearman +2 · investigacion:scout_german |
| 14 | F3 produccion mixta | 2 | campo:ironMine -> nivel 7 · reclutamiento:clubswinger +16 |
| 15 | F3 produccion mixta | 2 | reclutamiento:spearman +2 · campo:woodcutter -> nivel 6 |
| 16 | F3 produccion mixta | 2 | campo:cropland -> nivel 7 · campo:woodcutter -> nivel 6 |
| 17 | F3 produccion mixta | 2 | reclutamiento:spearman +3 · campo:woodcutter -> nivel 6 |
| 18 | F3 produccion mixta | 2 | campo:cropland -> nivel 7 · campo:clayPit -> nivel 6 |
...
| 25 | F4 presion y tecnologia | 2 | construccion:barracks -> nivel 12 · campo:cropland -> nivel 6 |
| 26 | F4 presion y tecnologia | 2 | campo:woodcutter -> nivel 8 · campo:cropland -> nivel 6 |
| 27 | F4 presion y tecnologia + drill expansion | 3 | expansion:germans_main funda germans_main_exp_1 en 53/54 |
| 28 | F4 presion y tecnologia | 3 | campo:woodcutter -> nivel 8 · campo:woodcutter -> nivel 7 · campo:woodcutter -> nivel 2 |
| 29 | F4 presion y tecnologia | 3 | campo:woodcutter -> nivel 8 · campo:woodcutter -> nivel 7 · campo:woodcutter -> nivel 2 |
| 30 | F4 presion y tecnologia | 3 | campo:clayPit -> nivel 8 · campo:woodcutter -> nivel 7 · campo:woodcutter -> nivel 2 |
...
| E3 | Ataque estandar debil | standard_attack/medium → counterattack | counterattack (threat=medium) | raid@germans_main | 1 |
| E4 | Ataque multi-ola | multi_wave_attack/high → hold | hold (threat=high) | sin comandos | 0 |
| E5 | Asedio de media intensidad | siege_attack/high → full_dodge | partial_dodge (threat=high) | raid@germans_main | 0 |
| E6 | Ataque de conquista | conquest_attack/critical → full_dodge | partial_dodge (threat=critical) | raid@germans_main | 0 |

**Expansión**

- ✅ EXP-1: `germans_main` funda `germans_main_exp_1` en `53|54`.
...
## 🧩 Diagnóstico de avance germano

| Escenario | Clave esperada (`phase2`) ms | Clave alternativa detectada | ms alternativo | Señal de mismatch |
|---|---:|---|---:|---|
| seed_x1@1x | 5760000 | ninguna | 0 | ❌ No |
| seed_x100@100x | 5760000 | ninguna | 0 | ❌ No |
| seed_x1000@1000x | 11520000 | ninguna | 0 | ❌ No |

### Resultado del diagnóstico
- ✅ No se detecta mismatch de clave en esta ejecución.
- ✅ El fix aplicado permite que germanos acumulen progreso en `phase2` y avancen a fases superiores.

## 🏁 Conclusión
- El harness reproduce comportamiento táctico y de expansión en ambos perfiles.
- Egipcios mantienen identidad defensiva y expansión segura en drill.
